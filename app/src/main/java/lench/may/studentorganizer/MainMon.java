...
public class MainMon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_mon);
    ...
    public void onResume() {
        ...
        lessonsCursor = db.rawQuery("select * from " + ScheduleContract.AddLesson.TABLE_NAME + " where "
                + ScheduleContract.AddLesson.COLUMN_DAY + " like 'Понедельник' order by " + ScheduleContract.AddLesson.COLUMN_START_H, null);
        String[] headers = new String[]{ScheduleContract.AddLesson.COLUMN_SUBJ};
        lessonsAdapter = new SimpleCursorAdapter(this, R.layout.activity_list_item11,
