...
public class MainWed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_wed);
    ...
    public void onResume() {
        ...
        lessonsCursor = db.rawQuery("select * from " + ScheduleContract.AddLesson.TABLE_NAME + " where "
                + ScheduleContract.AddLesson.COLUMN_DAY + " like 'Среда' order by " + ScheduleContract.AddLesson.COLUMN_START_H, null);
